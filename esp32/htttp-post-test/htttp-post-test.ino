...
const char* BLE_NETWORK_API = "https://ble-network-api.azurewebsites.net/loc/1"; // endpoint ble-network-api
...
void updateCurSecond() {
  if(WiFi.status()== WL_CONNECTED){
      ...
      cursecond = parsePayload(payload);
